...
export default function Home() {
  const durationOptions = [
    { title: "6 Hours", keyDuration: "6 Hours", checkpoints: "1" },
    { title: "12 Hours", keyDuration: "12 Hours", checkpoints: "2" },
    { title: "1 Day", keyDuration: "24 Hours", checkpoints: "3" },
    { title: "3 Days", keyDuration: "48 Hours", checkpoints: "5" },
    { title: "5 Days", keyDuration: "120 Hours", checkpoints: "8" },
    { title: "7 Days", keyDuration: "168 Hours", checkpoints: "10" }
  ]
    ...
    <>
      <section className="flex flex-col items-center justify-center min-h-screen text-center px-4">
        <main className="container mx-auto py-10 px-4">
          <br />
          <FadeInSection>
            <h1 className="text-3xl font-bold text-center mb-10">Select Whitelist Duration</h1>
          </FadeInSection>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
            {durationOptions.map((option, index) => (
              <FadeInSection key={index}>
                <Card className="h-full flex flex-col bg-transparent border-2 rounded-lg transition-all duration-300 ease-in-out scale-90 transform hover:border-blue-500 hover:scale-100 border-2 border-transparent">
                  <CardHeader>
